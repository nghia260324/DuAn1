...
public class SaveRecipe {
    public void OpenDialogSaveRecipe(Context context, CongThuc congThuc, MainActivity mainActivity) {
        ...
        CongThucDao congThucDao = new CongThucDao(context);
...
//            }
            ...
            for (DanhSachCongThuc DSCT:lstDSCT){
                ...
                if (congThucDao.checkExists("CongThuc_DSCT","idCongThuc = '" + congThuc.getId() + "' AND idDanhSachCongThuc",String.valueOf(DSCT.getId()))) {
